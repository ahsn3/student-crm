#!/usr/bin/env python3
"""Generate Flyway migration for Kent and Lokman Hekim programs."""
...
SRC = ROOT / "scripts" / "kent_lokman_programs.json"
OUT = ROOT / "src/main/resources/db/migration/V38__seed_kent_lokman_programs.sql"
